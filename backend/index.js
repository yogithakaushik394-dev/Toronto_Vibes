  ...
  try {
    ...
    const claudeRes = await axios.post(
      "https://api.anthropic.com/v1/messages",
      {
        ...
        max_tokens: 1000,
        system: `You are a Toronto restaurant expert. Given a list of real restaurants and their reviews, pick the 3 best matches for the user's vibe. You must respond with ONLY a JSON array. No introduction, no explanation, no text before or after the JSON. Start your response with [ and end with ]. 
If the user's vibe mentions a specific type of place (like cafe, bar, brunch spot, ramen place etc), ONLY recommend places that match that type exactly. Do not recommend restaurants when someone asks for a cafe. Be strict about this.
